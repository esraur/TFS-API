<%@ Page Language="C#" MasterPageFile="TFSWeb.Master" AutoEventWireup="true" CodeBehind="DeleteDetail.aspx.cs" Inherits="CognitiveSoftware.TeamFoundation.Integration.DeleteDetail" Title="Delete Detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CenterContent" runat="server">
    ...
    <table align="center" border="1" cellpadding="1" cellspacing="1">
        ...
        <tr>
            <td class="label" style="width: 141px">Finish Date:</td>
            <td class="dataGrid" style="width: 144px">
                <asp:Literal runat="server" ID="fdate" /></td>
        ...
        <tr>
            <td class="label" valign="top" style="width: 141px">Steps to Reproduce:</td>
            <td class="dataGrid" style="width: 144px">
                <asp:Literal runat="server" ID="reproduce" /></td>
        </tr>
