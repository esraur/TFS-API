...
namespace CognitiveSoftware.TeamFoundation.Integration
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            parameters.Add("project", DataManager.DevelopmentProject.Name);
            //int b = Convert.ToInt32(TextBox1.Text);
            string query = "SELECT [System.Id], [System.WorkItemType], [System.AssignedTo], [System.CreatedBy] FROM WorkItems WHERE [System.TeamProject] = @project AND [System.Id] =  '" + TextBox1.Text.Trim() + "'   ORDER BY [System.WorkItemType], [System.Title], [Microsoft.VSTS.Common.Priority], [System.Id]";
            WorkItemCollection items = DataManager.DevelopmentProject.Store.Query(query, parameters);
            GridView1.DataSource = items;
            GridView1.DataBind();
        }
